...
const authApi = axios.create({
  baseURL: import.meta.env.VITE_API_URL
    ...
    : "http://localhost:3000/auth",  // Asegúrate de usar la URL correcta para la autenticación
  withCredentials: true,  // Permite enviar cookies de sesión si es necesario
});
...
const usersApi = axios.create({
  baseURL: import.meta.env.VITE_API_URL
    ...
    : "http://localhost:3000/users",  // Asegúrate de usar la URL correcta para los usuarios
  withCredentials: true,  // Permite enviar cookies de sesión si es necesario
});
